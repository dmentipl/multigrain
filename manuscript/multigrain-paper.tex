...
\begin{figure*}
   \begin{center}
      \includegraphics[width=\textwidth]{figs/dustywave_velocity_density.pdf}
...
\begin{figure*}
   \begin{center}
      \includegraphics[width=\textwidth]{figs/dustyshock_velocity_density.pdf}
      \caption{Dusty shock numerical test showing the velocity (top) and the
         ...
         \citet{Benitez-Llambay2019ApJS..241...25B}.\label{fig:dustybox}}
   \end{center}
\end{figure*}

...
\begin{align}
   ...
   v^{\rm g}_R = \frac{\lambda_1 v_{\rm P} + (1 + \lambda_0) v_{\rm visc}}
      {(1 + \lambda_0)^2 + \lambda_1^2},
\end{align}
%
...
\begin{align}
   ...
   v^{\rm d_i}_R = \frac{v_{\rm P} [(1 + \lambda_0) \mathrm{St}_i - \lambda_1]
      + v_{\rm visc} (1 + \lambda_0 + \mathrm{St}_i \lambda_1)}
      {[(1 + \lambda_0)^2 + \lambda_1^2] (1 + \mathrm{St}_i^2)},
\end{align}
%
...
0.05\) at \(R=1\)~au. We used an artificial viscosity parameter \(\alpha=0.74\).
We set the initial radial velocities to zero. We set the orbital velocities to
account for the pressure gradient; see Section~3.3 of
\citet{Price2018PASA...35...31P} for details. Initially, the dust sub-discs are
co-located with the gas disc.

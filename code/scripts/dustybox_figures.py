...
def time_evolution():
    ...
    for ax in axs[:3]:
        ax.text(0.9, 0.9, r'$\varepsilon = 0.01$', ha='right', transform=ax.transAxes, bbox=props)
    for ax in axs[3:]:
        ax.text(0.9, 0.9, r'$\varepsilon = 0.5$', ha='right', transform=ax.transAxes, bbox=props)

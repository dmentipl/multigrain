...
\begin{figure}
   \begin{center}
      ...
      \caption{Dusty shock initial conditions. We use a smoothed density
         profile. The particles are placed on a close packed lattice. The
         density is lower in the pre-shock region, on the left, than on the
         right. The particle positions in the shock region are adjusted to
         smooth the shock over a few particle spacings.%
